...
>
> 40+ 上游供应商路由 · 格式翻译 · 模型 Combo / 多账号 fallback · 配额包到期优先调度 · OAuth / API-key 凭据管理 · Token 刷新 · 配额用量追踪 · 桌面客户端 · 可选云端同步
>
...
| 项目 | 版本 | 说明 |
|------|------|------|
| [**9Router fnOS**](https://github.com/techysy/9router-fnos) | ![Release](https://img.shields.io/github/v/release/techysy/9router-fnos) | 9Router（FREE AI Router）原生版 fnOS 应用 · 10Router 同源上游 |
...
| 项目 | 版本 | 说明 |
|------|------|------|
| [**strava-panel**](https://github.com/techysy/strava-panel) | ![Release](https://img.shields.io/github/v/release/techysy/strava-panel) | 骑行数据面板 fnOS 应用 · 凭据 + Token 自动刷新 + 统计可视化 |
| [**spot-studio**](https://github.com/techysy/spot-studio) | — | 🚴🥾 骑行 & 徒步活动发布平台（GPX 渲染 / 海拔 / POI） |
| [**tianfu-greenway-ranking**](https://github.com/techysy/tianfu-greenway-ranking) | — | 成都绕城绿道逆时针单飞 ITT 排行榜 |
| [**yangyu-strava-skill**](https://github.com/techysy/yangyu-strava-skill) | — | Strava API Hermes 技能 · OAuth 管理 / 活动数据 / 骑行分析 |
| [**outdoor-trip-planner**](https://github.com/techysy/outdoor-trip-planner) | — | 户外出行规划 Hermes 技能 · 天气 / 高铁 / 路线 / 组队 |
...
- 📝 Blog：[shiyangyu.com](https://shiyangyu.com) · [techysy.github.io](https://techysy.github.io)
